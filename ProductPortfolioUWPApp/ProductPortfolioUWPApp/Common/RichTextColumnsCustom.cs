...
namespace ProductPortfolioUWPApp.Common
{
    /// <summary>
    ...
    public sealed class RichTextColumnsCustom : Panel
    {
        /// <summary>
        ...
        public static readonly DependencyProperty RichTextContentProperty =
            ...
            typeof(RichTextColumnsCustom), new PropertyMetadata(null, ResetOverflowLayout));
        ...
        private static void ResetOverflowLayout(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            var target = d as RichTextColumnsCustom;
            if (target != null)
            {
